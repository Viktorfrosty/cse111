from water_flow import water_column_height, pressure_gain_from_water_height, pressure_loss_from_pipe, pressure_loss_from_fittings, reynolds_number, pressure_loss_from_pipe_reduction, kilopascals_to_pounds_per_square_inch
from pytest import approx
import pytest

# all the test functions calling parameters were modified to accept the value of the challenge constants.
...
def test_pressure_loss_from_fittings():
    ...
    """test function that call pressure_loss_from_fittings function to verify that it is working correctly."""
...
def test_reynolds_number():
    ...
    """test function that call reynolds_number function to verify that it is working correctly."""
...
def test_pressure_loss_from_pipe_reduction():
    ...
    """test function that call pressure_loss_from_pipe_reduction function to verify that it is working correctly."""
...
def test_kilopascals_to_pounds_per_square_inch(): # challenge

    """test function that call kilopascals_to_pounds_per_square_inch function to verify that it is working correctly."""

    assert kilopascals_to_pounds_per_square_inch(158.7) == approx(23.0175, 0.001)
    assert kilopascals_to_pounds_per_square_inch(253) == approx(36.6945, 0.001)
    assert kilopascals_to_pounds_per_square_inch(124.3) == approx(18.0282, 0.001)
    assert kilopascals_to_pounds_per_square_inch(75.1) == approx(10.8923, 0.001)
    assert kilopascals_to_pounds_per_square_inch(344.8) == approx(50.009, 0.001)
